(function(root, factory) {
  ...
  echarts.registerMap("深圳市", {
    type: "FeatureCollection",
    features: [
      {
        type: "Feature",
        properties: { cp: [113.962062, 22.579619], name: "南山区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [114.267576, 22.602827], name: "盐田区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [113.848455, 22.665555], name: "宝安区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [113.923662, 22.769082], name: "光明区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [114.017379, 22.690263], name: "龙华区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [114.040624, 22.54517], name: "福田区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [114.249467, 22.698205], name: "龙岗区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [114.357673, 22.673937], name: "坪山区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [114.483292, 22.617895], name: "大鹏区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
      ...
      {
        type: "Feature",
        properties: { cp: [114.142018, 22.575792], name: "罗湖区" },
        geometry: {
          type: "MultiPolygon",
          coordinates: [
            [
