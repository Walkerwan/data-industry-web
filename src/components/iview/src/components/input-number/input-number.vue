<template>
    <div :class="wrapClasses">
        ...
        <div :class="inputWrapClasses">
            <input :id="elementId" :class="inputClasses" :disabled="disabled" autocomplete="off" spellcheck="false" :autofocus="autofocus" @focus="focus" @blur="blur" @keydown.stop="keyDown" @input="change" @mouseup="preventDefault" @change="change" :readonly="readonly || !editable" :name="name" :value="formatterValue" :placeholder="placeholder">
        </div>
    </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    keyDown(e) {
      if (this.isInteger && e.keyCode === 46) {
        e.preventDefault();
        return false;
      }
      if (e.keyCode === 38) {
